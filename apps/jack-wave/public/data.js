// Jack Wave - Song Data (Deduplicated)
// Song library stores each unique song once; playlists reference by trackId
var __DATA__ = {
  songLibrary: {
  "40284751": {
  ...
  "1273853452": {
    ...
    "artist": "林俊杰",
    "duration": "3:40",
    "previewUrl": "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/3a/be/5e/3abe5e06-265e-f6dd-978c-9cb0f9892053/mzaf_16278102155509705614.plus.aac.p.m4a",
  ...
  "1894316978": {
    ...
    "duration": "3:06",
    "previewUrl": "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/7f/1b/0b/7f1b0b1c-db68-e8af-2282-22787dee6b27/mzaf_15817098001181933357.plus.aac.p.m4a",
  ...
  "6781003715": {
    ...
    "artworkUrl100": "https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/cd/8d/c6/cd8dc65d-a2e7-e867-c875-b81d4b39d23a/26UMGIM78226.rgb.jpg/100x100bb.jpg",
    "trackId": "6781003715"
  },
  "1620358546": {
  ...
  // Resolve song references to full song objects
  resolveSongs: function(ids) {
    return (ids || []).map(function(id) {
      var s = this.songLibrary[id];
      if (!s) { console.warn('Song not found:', id); return null; }
      return s;
    }.bind(this)).filter(function(s) { return s !== null; });
  }
};
